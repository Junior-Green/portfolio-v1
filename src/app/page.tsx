...
export default function Home() {
  ...
  const email = "jujugreen10@gmail.com"
  ...
  return (
    <main className="w-full h-full leading-relaxed tracking-wide flex md:flex-row md:px-[8%] sm:px-[4%] sm:flex-col">
      ...
      <div className=" h-auto md:w-1/2 sm:w-full md:py-[8%] sm:pb-[8%] flex flex-col">
        ...
        <ListView>
          <Project imgSrc={"/Y.png"} projectName={"Y - (In Development)"} desc={"Social media web platform inspired by X (formerly known as Twitter)."} languagesAndFrameworks={['TypeScript', 'React', 'Vite', 'PostgreSQL', 'Java', 'Tomcat', 'Spring Boot', 'Hibernate', 'AWS', 'Tailwind CSS', 'Docker']} link={""} />
